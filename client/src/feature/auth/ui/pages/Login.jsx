  ...
  return (
    <main className="min-h-screen bg-[#080808] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-40 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-white/[0.035] blur-3xl" />

        <div className="absolute top-1/3 -left-40 h-80 w-80 rounded-full bg-zinc-600/[0.06] blur-3xl" />

        <div className="absolute bottom-0 -right-40 h-96 w-96 rounded-full bg-zinc-500/[0.05] blur-3xl" />
      ...
      <section className="relative z-10 flex min-h-[calc(100vh-80px)] items-center justify-center px-4 py-10">
        <div className="w-full max-w-[430px]">
          {/* Card */}
          <div className="rounded-3xl border border-white/[0.09] bg-[#111111]/80 p-6 shadow-2xl shadow-black/40 backdrop-blur-xl sm:p-8">
            {/* Logo */}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <button
                ...
                className="group flex w-full items-center justify-center gap-2 rounded-xl bg-white py-3 text-sm font-semibold text-black transition hover:bg-zinc-200 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50"
              >
